...
function TTGPermissions.VerifyCameraAccess(): boolean;
begin
  Result := false;
...
constructor TTGPermissions.Create();
begin
{$IFDEF ANDROID}
...
procedure TTGPermissions.PermissionRequestResult(Sender: TObject;
  const APermissions: TArray<string>;
  const AGrantResults: TArray<TPermissionStatus>);
var
  ret: boolean;
...
procedure TTGPermissions.Camera(ActionPhoto: TTakePhotoFromCameraAction;
  ACallBackError: TCallbackProc = nil);
begin
...
procedure TTGPermissions.PhotoLibrary(ActionLibrary
...
procedure TTGPermissions.Location(ACallBack: TCallbackProc = nil;
  ACallBackError: TCallbackProc = nil);
begin
...
procedure TTGPermissions.PhoneState(ACallBack: TCallbackProc = nil;
  ACallBackError: TCallbackProc = nil);
begin
  MyCallBack := ACallBack;
  MyCallBackError := ACallBackError;
